...
public class SecondaryAddManifestation extends AppCompatActivity {
    ...
    public void onBackPressed() {
        super.onBackPressed();
        Intent intent = new Intent(SecondaryAddManifestation.this, DailyManifestation.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_secondary_add_manifestation);
    ...
    private void apiAddManifestation(){
        ...
        ApiModelClass.GetApiResponse(Request.Method.POST, Constants.URL.ADDMANIFESTATION, SecondaryAddManifestation.this, postParam, headers, new ServerCallback() {
            @Override
        ...
        if (!(view instanceof EditText)) {
            view.setOnTouchListener(new View.OnTouchListener() {
                public boolean onTouch(View v, MotionEvent event) {
                    hideSoftKeyboard(SecondaryAddManifestation.this);
                    return false;
                }
            });
        }
