...
public class ApiModelClass {
    ...
    public static void GetApiResponse(int method, String url , final Context ctxt, Map<String, String> postParam, final HashMap<String, String> headers, final ServerCallback callback) {
